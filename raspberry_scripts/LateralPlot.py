...
fig = plt.figure("Lateral Acceleration versus Time")
...
fileName = os.path.join(open_path, file_name+"_lateral.txt")
...
plt.get_current_fig_manager().window.wm_geometry("+1300+550")
